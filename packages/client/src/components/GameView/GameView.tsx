        ...
        steps={[
          {
            title: 'А как играть?',
            description:
              'Персонаж всегда куда-то бежит направо. Зарабатывайте очки, собирая монетки, и перепрыгивайте ящики, чтобы не получать урон. Когда урон станет невыносимым (10), игра закончится. Прыгать можно по пробелу, а дважды прыгать по дважды пробелу',
